...
namespace ParsnipWebsite
{
    public partial class Watch_Video : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Page.Header.Controls.Add(new LiteralControl(string.Format("<meta property=\"og:image\" content=\"{0}\" />", myVideo == null ? string.Format("https://i.ytimg.com/vi/{0}/hqdefault.jpg", myYoutubeVideo.DataId) : string.Format("{0}/{1}", Request.Url.GetLeftPart(UriPartial.Authority), myVideo.Thumbnail.Compressed.Replace(" ", "%20")))));
